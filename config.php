...
$config = array(
    ...
    //异步通知地址
    'notify_url' => "http://www.zhiweihome.com/zhixiu/piano/ali_notify.php",
    //同步跳转
    'return_url' => "http://www.zhiweihome.com/zhixiu/piano/",
    //编码格式
    'charset' => "UTF-8",
    //签名方式
    'sign_type' => "RSA2",
...
$_SERVER['database_config'] = $database_config;

$wxpay_config = array(
    'notify_url' => 'http://www.zhiweihome.com/zhixiu/piano/wx_notify.php',
    'redirect_url' => 'http://www.zhiweihome.com/zhixiu/piano/'
);
$_SERVER['wxpay_config'] = $wxpay_config;
