...
<div class="my-edit" >
    ...
    <div class="edit-item">
        <span class="edit-fenlei">类型</span>
        <select id="instrument">
            <option value="1">排练场</option>
            <option value="2">演出场</option>
            <option value="3">相亲角</option>
            <option value="4">弄堂里</option>
            <option value="5">交友角</option>
        </select>
    </div>
    ...
    <div class="edit-item edit-textarea">
        <p>详    情</p>
        <textarea name="" placeholder="琴行详情介绍1-100字" id="desc"></textarea>
    </div>
</div>
