...
<div class="my-edit">
    <div class="edit-item">
        <span class="edit-fenlei">
            <em>*</em>名称</span>
        <input type="text" id="name" value="<?php echo $detail['name']; ?>">
    </div>
    <div class="upload-media">
        <i class="iconfont icon-yinle"></i><span id="url"><?php echo base_url() . $detail['url']; ?></span>
        <input type="file" name="files" data-url="<?php echo base_url(); ?>index.php/Example/UploadImage?id=url&maker=works">
    </div>
</div>
