...
<div class="my-edit" >
    ...
    <div class="edit-item">
        <span class="edit-fenlei">
            <em>*</em>标题</span>
        <input type="text" placeholder="2-30字" id="title" value="<?php echo $detail['title']; ?>">
    </div>
    <div class="edit-item">
        <span class="edit-fenlei">
            日期</span>
        <input readonly id="demo1" value="<?php echo $detail['time']; ?>">
    </div>

    <div class="edit-item">
        <span class="edit-fenlei">
            <em>*</em>标签</span>
        <input type="text" placeholder="不超过5个字" id="tag" value="<?php echo $detail['tag']; ?>">
    </div>
    <div class="edit-item edit-textarea">
        <p><em style="color:red;">*</em>内    容</p>
        <textarea name="" id="desc" placeholder="新闻内容1-100字"><?php echo $detail['desc']; ?></textarea>
    </div>
</div>
