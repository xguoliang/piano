...
<div class="store-intro">
    <div class="store-hd">
        ...
        <div class="store-dt">
            ...
            <p class="store-tel"><i></i><span style="font-size:0.24rem;"><?php echo $company['address'] ?></span></p>
            <p class="store-add"><i></i><span style="font-size:0.24rem;"><?php echo $company['phone'] ?></span></p>
        </div>
    </div>
    <div class="store-bd">
...
<div class="store-fenlei">
    <div class="store-fenlei-info">
        <ul id="type">
            <li class="active" onclick="window.location.href = '<?php echo base_url() ?>User/Company/CompanyDetail?id=<?php echo $company['id'] ?>'">商品</li>
...
<div class="good-list store-good-list" style="margin-top:.2rem;">
...
<script>
                    ...
                    function FetchProduct() {
                        ...
                        var data = {
                            ...
                            , brand_id: ($("#brand_id").find("active").length > 0) ? $("#brand_id").find("active").attr('src') : 0
                            , type: 1
                        };
                        $.post(url, data, function (res) {
                            ...
                            for (var i = 0; i < res.length; i++) {
                                ...
                                htmlStr += '' +
                                        ' <li>\n' +
                                        '            <div class="good-img">\n' +
                                        '                <a href="<?php echo base_url() ?>User/Product/PProductDetail?id=' + res[i].id + '"><img src="<?php echo base_url() ?>' + res[i].coverimg.split(',')[0] + '" alt=""></a>\n' +
                                        '            </div>\n' +
                                        '            <div class="good-txt">\n' +
                                        '                <a href="<?php echo base_url() ?>User/Product/PProductDetail?id=' + res[i].id + '"><p class="good-name">' + res[i].name + '</p></a>\n' +
                                        '                <p class="good-dt"><span class="good-add"><?php echo $company['area'] ?></span><span class="good-fenlei">' + res[i].ins_name + '</span>' +
                                        // '<span class="good-local">'+distance+'</span>' +
                                        '</p>\n' +
                                        '                <p class="good-price"><em class="good-price1"><span class="price-icon">¥</span><span class="price-num">' + res[i].price + '</span></em><button onclick="CollectProduct(' + res[i].id + ')" class="collect">收藏</button></p>\n' +
                                        '            </div>\n' +
                                        '        </li>';
                            }
