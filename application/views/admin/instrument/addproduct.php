            ...
            <div class="ibox-content">
                <div class="edit_info">
                    <div class="form-group">
                        ...
                        <input  id="name" class="form-control left cwidth" type="text" placeholder="请填写乐器名称" value="<?php
                        if (isset($one)) {
                            echo $one['name'];
                        }
                        ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input  id="sort" class="form-control left cwidth" type="number" placeholder="请填写乐器排序" value="<?php
                        if (isset($one)) {
                            echo $one['sort'];
                        }
                        ?>">
        ...
        $.post(url, data, function (res) {
            if (res.status == 1) {
                layer.msg('保存成功！', {time: 1500}, function () {
                    window.location.href = "InstrumentList.html";
                });
            }
        }, "json");
    }
