            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 14px 20px 10px;">
                    <div class="input-group" style="float: left;width: 40%;">
                        ...
                        <input id="name" type="text" placeholder="请输入乐器名称" class="input-sm form-control"
                               style="width: 200px;height: 32px">
                    </div>
                    <div class="ibox-tools">
                        <a><span class="btn btn-primary" onclick="AddOne()">添加乐器</span></a>
                    </div>
                ...
                <div class="ibox-content" style="padding: 15px 40px 20px 40px;">
                    <table class="table table-striped table-bordered table-hover dataTables-example nowarp"
                        ...
                        <tbody id="instrument_list"></tbody>
                    </table>
                    <div style="text-align: center;">
                        <div id="instrument_list_page"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function FetchPageData(limit, page) {
        ...
        $.post(url, data, function (res) {
            ...
            $("#instrument_list").html(HtmlStr);
        }, "json");
    }

    function AddOne(id = '') {
        window.location.href = "<?php echo base_url() ?>Admin/Instrument/AddOne?id=" + id;
    }
