            ...
            <div class="ibox-content">
                <div class="edit_info">
                    <div class="form-group">
                        ...
                        <input  id="name" class="form-control left cwidth" type="text" placeholder="请填写乐手名称" value="<?php if(isset($one)){echo $one['name'];}?>">
                        <div class="clear"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="clear"></div>
                        <div style="margin:30px 0 0 75px;color:red;">注：此图片为乐手图片</div>
                    </div>
                    <div class="form-group">
