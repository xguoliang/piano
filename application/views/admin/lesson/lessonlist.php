            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 14px 20px 10px;">
                    <div class="input-group" style="float: left;width: 40%;">
                        ...
                        <input id="name" type="text" placeholder="请输入课程名称" class="input-sm form-control"
                               style="width: 200px;height: 32px">
                    </div>
<!--                    <div class="ibox-tools">-->
<!--                        <a><span class="btn btn-primary" onclick="AddOne()">添加课程</span></a>-->
<!--                    </div>-->
...
<script>
        ...
        $.post(url, data, function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                HtmlStr += '' +
                    ...
                    '    <td>' + res[i].name + '</td>' +
                    '    <td>' +
                    '       <img style="width:36px;" src="<?php echo base_url()?>' + res[i].coverimg + '">' +
                    '   </td>' +
    ...
    function AddOne(id = '') {
        window.location.href = "<?php echo base_url() ?>index.php/Admin/Lesson/AddOne?id=" + id;
    }
</script>