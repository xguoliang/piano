            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 14px 20px 10px;">
                    <div class="ibox-tools">
                        <a><span class="btn btn-primary" onclick="AddOne()">添加推荐</span></a>
                    </div>
                ...
                <div class="ibox-content" style="padding: 15px 40px 20px 40px;">
                    <table class="table table-striped table-bordered table-hover dataTables-example nowarp"
                        ...
                        <tbody id="recommend_list"></tbody>
                    </table>
                    <div style="text-align: center;">
                        <div id="recommend_list_page"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function AddOne(id = '') {
        window.location.href = "<?php echo base_url() ?>index.php/Admin/Recommend/AddOne?id=" + id;
    }
