                    ...
                    <div class="form-group">
                        ...
                        <div class="left">
                            <div class="upload pic_upload">上传图片
                                <input type="file" name="files" data-url="<?php echo base_url(); ?>index.php/Example/UploadImage?id=img&maker=recommend">
                            </div>
                            <div class="pic_box">
        ...
        $.post(url,data,function(res){
            if(res.status == 1){
                layer.msg("保存成功!",{time:1500},function(){
                    window.location.href = "<?php echo base_url()?>Admin/Recommend/RecommendList";
                })
            }else{
