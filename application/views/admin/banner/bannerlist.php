            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 14px 20px 10px;">
                    <div class="ibox-tools">
                        <a><span class="btn btn-primary" onclick="AddOne()">添加轮播</span></a>
                    </div>
...
<script>
        ...
        $.post(url, data, function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                HtmlStr += '' +
                    ...
                    '    <td class="operate">' +
                    '       <span class="btn btn-primary"  onclick="ChangeLink('+res[i].id+',this)">是</span>' +
                    '    </td>' +
                    '    <td class="operate">' +
    ...
    function AddOne(id = '') {
        window.location.href = "<?php echo base_url() ?>index.php/Admin/Banner/AddOne?id=" + id;
    }
