...
<!--                    </div>-->
                ...
                <div class="ibox-content" style="padding: 15px 40px 20px 40px;">
                    <table class="table table-striped table-bordered table-hover dataTables-example nowarp"
                        ...
                        <tbody id="sitelease_list"></tbody>
                    </table>
                    <div style="text-align: center;">
                        <div id="sitelease_list_page"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function FetchPageData(limit, page) {
        ...
        $.post(url, data, function (res) {
            ...
            $("#sitelease_list").html(HtmlStr);
        }, "json");
    }

    function AddOne(id = '') {
        //window.location.href = "<?php //echo base_url() ?>//index.php/Admin/siteleasesman/AddOne?id=" + id;
    }
</script>