            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="padding: 14px 20px 10px;">
                    <div class="input-group" style="float: left;width: 40%;">
                        ...
                        <input id="title" type="text" placeholder="请输入头条名称" class="input-sm form-control"
                               style="width: 200px;height: 32px">
                    </div>
                    <!--                    <div class="ibox-tools">-->
                    <!--                        <a><span class="btn btn-primary" onclick="AddOne()">添加头条</span></a>-->
                    <!--                    </div>-->
...
<script>
    ...
    function AddOne(id = '') {
        //window.location.href = "<?php //echo base_url() ?>//index.php/Admin/Headline/AddOne?id=" + id;
    }
